...
#P11
execute unless entity @a[scores={4j.pid=11}] run player 11 spawn
#P12
execute unless entity @a[scores={4j.pid=12}] run player 12 spawn
#P13
execute unless entity @a[scores={4j.pid=13}] run player 13 spawn
#P14
execute unless entity @a[scores={4j.pid=14}] run player 14 spawn
#P15
execute unless entity @a[scores={4j.pid=15}] run player 15 spawn
#P16
execute unless entity @a[scores={4j.pid=16}] run player 16 spawn
...
tag 13 add debugforceacceptresource
tag 14 add debugforceacceptresource
tag 15 add debugforceacceptresource
tag 16 add debugforceacceptresource
#Run
