...
execute as @e[type=glow_item_frame] run data merge entity @s {Invulnerable:1}
execute as @e[type=glow_item_frame] unless entity @s[nbt={Item:{}}] run data merge entity @s {Fixed:1}
