##Copy armor
#Move to container
execute in minecraft:overworld run item replace block -339 4 -341 container.0 from entity @s[scores={4j.pid=1}] armor.feet 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.1 from entity @s[scores={4j.pid=2}] armor.feet 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.2 from entity @s[scores={4j.pid=3}] armor.feet 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.3 from entity @s[scores={4j.pid=4}] armor.feet 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.4 from entity @s[scores={4j.pid=5}] armor.feet 4jbattle:game/autoequip
