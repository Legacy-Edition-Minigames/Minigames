...
execute in minecraft:overworld run item replace block -339 4 -341 container.8 from entity @s[scores={4j.pid=9}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.9 from entity @s[scores={4j.pid=10}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.10 from entity @s[scores={4j.pid=11}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.11 from entity @s[scores={4j.pid=12}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.12 from entity @s[scores={4j.pid=13}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.13 from entity @s[scores={4j.pid=14}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.14 from entity @s[scores={4j.pid=15}] armor.head 4jbattle:game/autoequip
execute in minecraft:overworld run item replace block -339 4 -341 container.15 from entity @s[scores={4j.pid=16}] armor.head 4jbattle:game/autoequip
#Copy new armor
