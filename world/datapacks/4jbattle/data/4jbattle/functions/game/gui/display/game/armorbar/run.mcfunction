...
##Display
#Scale 1
execute as @s[advancements={4jbattle:config/guiscale/1=true}] run function 4jbattle:game/gui/display/game/armorbar/1
#Scale 2
execute as @s[advancements={4jbattle:config/guiscale/2=true}] run function 4jbattle:game/gui/display/game/armorbar/2
#Scale 3
execute as @s[advancements={4jbattle:config/guiscale/3=true}] run function 4jbattle:game/gui/display/game/armorbar/3
#Scale 4
execute as @s[advancements={4jbattle:config/guiscale/4=true}] run function 4jbattle:game/gui/display/game/armorbar/4