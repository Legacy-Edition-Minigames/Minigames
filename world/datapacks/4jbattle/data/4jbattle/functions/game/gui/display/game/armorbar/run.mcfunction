...
##Display
#Scale 1
execute unless score #Store 4j.gimode matches 3 as @s[scores={4j.guiscale=1}] run function 4jbattle:game/gui/display/game/armorbar/1
#Scale 2
execute unless score #Store 4j.gimode matches 3 as @s[scores={4j.guiscale=2}] run function 4jbattle:game/gui/display/game/armorbar/2
#Scale 3
execute unless score #Store 4j.gimode matches 3 as @s[scores={4j.guiscale=3}] run function 4jbattle:game/gui/display/game/armorbar/3
#Scale 4
execute unless score #Store 4j.gimode matches 3 as @s[scores={4j.guiscale=4}] run function 4jbattle:game/gui/display/game/armorbar/4
