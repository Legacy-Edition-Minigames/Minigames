##Clear empty playerbars
#1
execute as @a[scores={4j.pid=1}] run scoreboard players reset #P1 4j.playerbar
#2
execute as @a[scores={4j.pid=2}] run scoreboard players reset #P2 4j.playerbar
#3
execute as @a[scores={4j.pid=3}] run scoreboard players reset #P3 4j.playerbar
#4
execute as @a[scores={4j.pid=4}] run scoreboard players reset #P4 4j.playerbar
#5
execute as @a[scores={4j.pid=5}] run scoreboard players reset #P5 4j.playerbar
#6
execute as @a[scores={4j.pid=6}] run scoreboard players reset #P6 4j.playerbar
#7
