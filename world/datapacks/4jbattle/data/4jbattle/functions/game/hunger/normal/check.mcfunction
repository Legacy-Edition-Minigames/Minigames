...
scoreboard players remove @a[scores={4j.rawhealth=..19,4j.hungerbar=1..},tag=!fullhungerinit] 4j.healtimer 1

##Heal players
execute as @a[scores={4j.healtimer=..0},tag=!fullhungerinit] run function 4jbattle:game/hunger/normal/heal/run
