...
##Cap at 20
scoreboard players set @a[tag=ingame,scores={4j.hungerbar=21..}] 4j.hungerbar 20
...
execute as @a[tag=ingame,tag=fullhunger,scores={4j.eat.goldapple=1..}] run function 4jbattle:game/hunger/normal/add/foodlist/golden_apple
