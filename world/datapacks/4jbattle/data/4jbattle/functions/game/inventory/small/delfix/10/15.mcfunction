...
execute if data entity @s {Inventory:[{Slot:24b}]} run data modify entity @e[type=item,limit=1,sort=nearest,tag=smallinvdelfix] Item set from block -335 66 -329 Items[0]
