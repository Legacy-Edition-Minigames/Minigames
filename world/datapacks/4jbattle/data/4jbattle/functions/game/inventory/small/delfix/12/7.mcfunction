...
item replace block -335 66 -338 container.11 from entity @s inventory.7
...
execute if data entity @s {Inventory:[{Slot:16b}]} run item replace block -335 66 -338 container.11 with air
