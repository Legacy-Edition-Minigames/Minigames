...
item replace block -335 66 -338 container.13 from entity @s inventory.13
...
execute if data entity @s {Inventory:[{Slot:22b}]} run item replace block -335 66 -338 container.13 with air
