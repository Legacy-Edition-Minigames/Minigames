...
execute if data entity @s {Inventory:[{Slot:23b}]} run data modify entity @e[type=item,limit=1,sort=nearest,tag=smallinvdelfix] Item set from block -335 66 -324 Items[0]
