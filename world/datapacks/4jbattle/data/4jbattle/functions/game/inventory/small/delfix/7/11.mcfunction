...
item replace block -335 66 -338 container.6 from entity @s inventory.11
...
execute if data entity @s {Inventory:[{Slot:20b}]} run item replace block -335 66 -338 container.6 with air
