...
item replace block -335 66 -338 container.7 from entity @s inventory.15
...
execute if data entity @s {Inventory:[{Slot:24b}]} run item replace block -335 66 -338 container.7 with air
