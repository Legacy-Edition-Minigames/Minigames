###Stops all the Battle related music

##Vanilla
#Battle1
stopsound @a music 4jbattle:music.vanilla.1
#Battle2
stopsound @a music 4jbattle:music.vanilla.2
#Battle3
stopsound @a music 4jbattle:music.vanilla.3
#Battle4
