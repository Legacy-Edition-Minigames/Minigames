##Load resource pack
#Non-Optifine
execute as @s[advancements={4jmenu:config/optifine=false,4jbattle:config/globalpack=false}] run loadresource greek
#Optifine
execute as @s[advancements={4jmenu:config/optifine=true,4jbattle:config/globalpack=false}] run loadresource greek-optifine
