...
##Spawn boats
execute as @e[tag=MTP] at @s run summon armor_stand ~ ~1.8 ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
execute as @e[tag=MTP] at @s run summon armor_stand ~ ~-0.563 ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
execute as @e[tag=MTP] at @s run summon armor_stand ~0.989999 ~0.5 ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
execute as @e[tag=MTP] at @s run summon armor_stand ~-0.989999 ~0.5 ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
execute as @e[tag=MTP] at @s run summon armor_stand ~ ~0.5 ~0.989999 {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
execute as @e[tag=MTP] at @s run summon armor_stand ~ ~0.5 ~-0.989999 {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["boatWall"],Passengers:[{id:"minecraft:boat",Silent:1b,Type:"acacia",Tags:["boatWall"],Passengers:[{id:"minecraft:marker",Tags:["boatWall"]},{id:"minecraft:marker",Tags:["boatWall"]}]}]}
##Freeze
