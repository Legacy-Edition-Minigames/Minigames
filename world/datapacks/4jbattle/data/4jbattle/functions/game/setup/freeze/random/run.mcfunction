...
#Player 9
execute as @e[type=area_effect_cloud,tag=F-RTP-9,sort=random,limit=1] at @s run tp @a[scores={4j.pid=9}] ~ ~ ~
#Player 10
execute as @e[type=area_effect_cloud,tag=F-RTP-10,sort=random,limit=1] at @s run tp @a[scores={4j.pid=10}] ~ ~ ~
#Player 11
execute as @e[type=area_effect_cloud,tag=F-RTP-11,sort=random,limit=1] at @s run tp @a[scores={4j.pid=11}] ~ ~ ~
#Player 12
execute as @e[type=area_effect_cloud,tag=F-RTP-12,sort=random,limit=1] at @s run tp @a[scores={4j.pid=12}] ~ ~ ~
#Player 13
execute as @e[type=area_effect_cloud,tag=F-RTP-13,sort=random,limit=1] at @s run tp @a[scores={4j.pid=13}] ~ ~ ~
#Player 14
execute as @e[type=area_effect_cloud,tag=F-RTP-14,sort=random,limit=1] at @s run tp @a[scores={4j.pid=14}] ~ ~ ~
#Player 15
execute as @e[type=area_effect_cloud,tag=F-RTP-15,sort=random,limit=1] at @s run tp @a[scores={4j.pid=15}] ~ ~ ~
#Player 16
