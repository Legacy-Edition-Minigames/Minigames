...
##Crucible
#Small
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:crucible_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:crucible 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:crucible_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:crucible_remastered 4jbattle:game/resource/dimensionloaded

##Cove
#Small
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cove_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cove 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cove_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cove_remastered 4jbattle:game/resource/dimensionloaded

##Cavern
#Small
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cavern_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cavern 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cavern_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:cavern_remastered 4jbattle:game/resource/dimensionloaded

##Frontier
#Small
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:frontier_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:frontier 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:frontier_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:frontier_remastered 4jbattle:game/resource/dimensionloaded

##Shrunk
#Small
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:shrunk_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:shrunk 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:shrunk_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:shrunk_remastered 4jbattle:game/resource/dimensionloaded
...
##Temple
#Small
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:temple_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:temple 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:temple_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:temple_remastered 4jbattle:game/resource/dimensionloaded
...
##Ruin
#Small
execute if score #Store 4j.map matches 11 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:ruin_small 4jbattle:game/resource/dimensionloaded
#Large
...
##Castle
#Small
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 1 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:castle_small 4jbattle:game/resource/dimensionloaded
#Large
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 2 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:castle 4jbattle:game/resource/dimensionloaded
#Large+
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 4 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:castle_largeplus 4jbattle:game/resource/dimensionloaded
#Remastered
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 3 run dimensionloader prepareDimension 4jbattle:arena 4jbattle:castle_remastered 4jbattle:game/resource/dimensionloaded
