...
##Crucible
#Small
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s 317 75 301
#Large
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s 347 36 331
#Large+
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s 347 36 331
#Remastered
execute if score #Store 4j.map matches 1 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s 347 36 331

##Cove
#Small
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s 219 64 -220
#Large
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s 45 64 251
#Large+
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s 45 64 251
#Remastered
execute if score #Store 4j.map matches 2 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s 45 64 251

##Cavern
#Small
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s -223 65 287
#Large
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s 268 28 12
#Large+
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s 268 28 12
#Remastered
execute if score #Store 4j.map matches 3 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s 268 29 12

##Frontier
#Small
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s 288 52 211
#Large
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s 288 52 211
#Large+
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s 288 52 211
#Remastered
execute if score #Store 4j.map matches 4 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s 288 52 211

##Shrunk
#Small
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s -82 31 134
#Large
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s 47 31 127
#Large+
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s 47 31 127
#Remastered
execute if score #Store 4j.map matches 5 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s 47 31 127
...
##Temple
#Small
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s -34 57 -253
#Large
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s -118 18 -149
#Large+
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s -118 18 -149
#Remastered
execute if score #Store 4j.map matches 9 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s -118 18 -149
...
##Ruin
#Small
execute if score #Store 4j.map matches 11 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s -206 14 178
#Large
...
##Castle
#Small
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 1 in 4jbattle:arena run tp @s 40 61 40
#Large
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 2 in 4jbattle:arena run tp @s -169 64 134
#Large+
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 4 in 4jbattle:arena run tp @s -169 64 134
#Remastered
execute if score #Store 4j.map matches 13 if score #Store 4j.maptype matches 3 in 4jbattle:arena run tp @s -169 64 134
