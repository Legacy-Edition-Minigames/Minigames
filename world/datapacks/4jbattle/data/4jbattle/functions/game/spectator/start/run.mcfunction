...
#Bat
execute if score #Store 4j.spectype matches 1 as @s[tag=!relogtimer,tag=!MobOverride] run function 4jbattle:game/spectator/spawn/bat
#Parrot
execute if score #Store 4j.spectype matches 2 as @s[tag=!relogtimer,tag=!MobOverride] run function 4jbattle:game/spectator/spawn/parrot
#Vex
...
#Bat
execute as @s[tag=!relogtimer,tag=MobOverride,advancements={4jbattle:config/patreon/mob/bat=true}] run function 4jbattle:game/spectator/spawn/bat
#Parrot
execute as @s[tag=!relogtimer,tag=MobOverride,advancements={4jbattle:config/patreon/mob/parrot=true}] run function 4jbattle:game/spectator/spawn/parrot
#Vex
