##Add damage dealt
execute as @a[tag=ingame,tag=player] run scoreboard players operation @s 4j.drawscore = @s 4j.damagedealt

##Remove damage taken
execute as @a[tag=ingame,tag=player] run scoreboard players operation @s 4j.drawscore -= @s 4j.damagetaken

##Add a bunch of score
scoreboard players add @a[tag=ingame] 4j.drawscore 9999999
...
scoreboard players remove @a[tag=ingame] 4j.drawscore 9999999
#Display
