##Get position
execute as @a[tag=ingame] at @s store result score @s 4j.xvalue run data get entity @s Pos[0]
execute as @a[tag=ingame] at @s store result score @s 4j.yvalue run data get entity @s Pos[1]
execute as @a[tag=ingame] at @s store result score @s 4j.zvalue run data get entity @s Pos[2]
