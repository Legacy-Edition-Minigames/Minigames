...
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=9}] armor.head from block -339 4 -341 container.8
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=10}] armor.head from block -339 4 -341 container.9
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=11}] armor.head from block -339 4 -341 container.10
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=12}] armor.head from block -339 4 -341 container.11
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=13}] armor.head from block -339 4 -341 container.12
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=14}] armor.head from block -339 4 -341 container.13
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=15}] armor.head from block -339 4 -341 container.14
execute in minecraft:overworld run item replace entity @s[scores={4j.pid=16}] armor.head from block -339 4 -341 container.15
