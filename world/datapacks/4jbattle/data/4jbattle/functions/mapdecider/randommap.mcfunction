...
#Large Capitol
execute if score #Store 4j.maptype matches 2.. if score #Capitol 4j.enablemap matches 1 if score #Store 4j.maprandom matches 21 run scoreboard players set #Store 4j.map 47
#Small Capitol
