...
##Lobby settings
#New lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/1/lobby/new=true}] run tellraw @s ["",{"text":"Old Lobby: ","italic":true,"color":"dark_aqua"},{"text":"Disabled","color":"red"}]
execute if entity @s[advancements={4jbattle:menu/host/presets/1/lobby/new=false}] run tellraw @s ["",{"text":"Old Lobby: ","italic":true,"color":"dark_aqua"},{"text":"Enabled","color":"green"}]
