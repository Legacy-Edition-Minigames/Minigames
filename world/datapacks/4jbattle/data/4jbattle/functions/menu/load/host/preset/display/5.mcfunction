...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/spectator/allay=true}] run tellraw @s ["",{"text":"Spectator Type: ","italic":true,"color":"dark_aqua"},{"text":"Allay","color":"green"}]
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/festive=true}] run tellraw @s ["",{"text":"Lobby: ","italic":true,"color":"dark_aqua"},{"text":"Festive","color":"green"}]
