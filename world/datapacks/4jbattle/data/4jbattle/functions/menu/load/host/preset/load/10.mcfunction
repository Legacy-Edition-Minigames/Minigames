...
##Combat style
#Classic
execute if entity @s[advancements={4jbattle:menu/host/presets/10/combat/style/classic=true}] run scoreboard players set #Store 4j.combatstyle 1
#Modern
execute if entity @s[advancements={4jbattle:menu/host/presets/10/combat/style/modern=true}] run scoreboard players set #Store 4j.combatstyle 2
#Custom
...
##1.9 Weapon Damage
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/10/combat/style/custom/moderndamage=true}] run scoreboard players set #Store 4j.setmoderndamage 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/10/combat/style/custom/moderndamage=false}] run scoreboard players set #Store 4j.setmoderndamage 0
