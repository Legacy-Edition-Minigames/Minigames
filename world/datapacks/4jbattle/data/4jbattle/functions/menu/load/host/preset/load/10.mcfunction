...
##Lobby settings
#Old lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/10/lobby/old=true}] run scoreboard players set #Store 4j.lobbytype 0
#New lobby
...
#Anniversary lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/10/lobby/anniversary=true}] run scoreboard players set #Store 4j.lobbytype 2
