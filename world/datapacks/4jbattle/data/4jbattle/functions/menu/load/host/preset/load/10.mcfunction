...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/bug/armorswapdrop=false}] run scoreboard players set #Store 4j.armorswapdrop 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/bug/foodcentral=false}] run scoreboard players set #Store 4j.foodcentfix 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/bug/leapfix=false}] run scoreboard players set #Store 4j.leapfix 0
#Large+ Cove Chests
...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/bug/largepluscove=false}] run scoreboard players set #Store 4j.lpluscovefix 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/chest/refill=false}] run scoreboard players set #Store 4j.chestrefill 0
#Random Power Chests
execute if entity @s[advancements={4jbattle:menu/host/presets/10/chest/randompower=true}] run scoreboard players set #Store 4j.randompowerchest 1
execute if entity @s[advancements={4jbattle:menu/host/presets/10/chest/randompower=false}] run scoreboard players set #Store 4j.randompowerchest 0
#Random config
...
#Festive lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/10/lobby/festive=true}] run scoreboard players set #Store 4j.setlobbytype 4
...
execute if entity @s[advancements={4jbattle:menu/host/presets/10/spectator/allay=true}] run scoreboard players set #Store 4j.spectype 6
...
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/10/mods/enabled=true}] run scoreboard players set #Store 4j.enablemods 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/10/mods/enabled=false}] run scoreboard players set #Store 4j.enablemods 0
