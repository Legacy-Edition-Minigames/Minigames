...
#Fast Healing
execute if entity @s[advancements={4jbattle:menu/host/presets/10/hunger/fasthealing=true}] run scoreboard players set #Store 4j.hungertype 2
#Beta
execute if entity @s[advancements={4jbattle:menu/host/presets/10/hunger/beta=true}] run scoreboard players set #Store 4j.hungertype 3
...
##Lobby settings
#New lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/10/lobby/new=true}] run scoreboard players set #Store 4j.lobbytype 1
execute if entity @s[advancements={4jbattle:menu/host/presets/10/lobby/new=false}] run scoreboard players set #Store 4j.lobbytype 0
...
#Enabled maps
execute if score #Store 4j.gamestatus matches 0 run function 4jbattle:menu/load/host/preset/load/10/maps
...
##Display as loaded
tellraw @s {"text":"Loaded Preset 10!","color":"green"}
