...
execute if entity @s[advancements={4jbattle:menu/host/presets/3/bug/armorswapdrop=true}] run scoreboard players set #Store 4j.armorswapdrop 1
...
execute if entity @s[advancements={4jbattle:menu/host/presets/3/bug/foodcentral=true}] run scoreboard players set #Store 4j.foodcentfix 1
...
execute if entity @s[advancements={4jbattle:menu/host/presets/3/bug/leapfix=true}] run scoreboard players set #Store 4j.leapfix 1
...
#Large+ Cove Chests
execute if entity @s[advancements={4jbattle:menu/host/presets/3/bug/largepluscove=true}] run scoreboard players set #Store 4j.lpluscovefix 1
...
execute if entity @s[advancements={4jbattle:menu/host/presets/3/chest/refill=false}] run scoreboard players set #Store 4j.chestrefill 0
#Random Power Chests
execute if entity @s[advancements={4jbattle:menu/host/presets/3/chest/randompower=true}] run scoreboard players set #Store 4j.randompowerchest 1
execute if entity @s[advancements={4jbattle:menu/host/presets/3/chest/randompower=false}] run scoreboard players set #Store 4j.randompowerchest 0
#Random config
...
#Festive lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/3/lobby/festive=true}] run scoreboard players set #Store 4j.setlobbytype 4
...
##Critical Attacks
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/3/combat/style/custom/criticals=true}] run scoreboard players set #Store 4j.setcriticalhits 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/3/combat/style/custom/criticals=false}] run scoreboard players set #Store 4j.setcriticalhits 0
