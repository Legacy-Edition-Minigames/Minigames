...
##Lobby settings
#Old lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/3/lobby/old=true}] run scoreboard players set #Store 4j.lobbytype 0
#New lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/3/lobby/new=true}] run scoreboard players set #Store 4j.lobbytype 1
#Anniversary lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/3/lobby/anniversary=true}] run scoreboard players set #Store 4j.lobbytype 2
