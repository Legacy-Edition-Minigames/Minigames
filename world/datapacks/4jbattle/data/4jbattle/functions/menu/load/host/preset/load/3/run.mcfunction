...
#Fast Healing
execute if entity @s[advancements={4jbattle:menu/host/presets/3/hunger/fasthealing=true}] run scoreboard players set #Store 4j.hungertype 2
#Beta
execute if entity @s[advancements={4jbattle:menu/host/presets/3/hunger/beta=true}] run scoreboard players set #Store 4j.hungertype 3
...
execute if entity @s[advancements={4jbattle:menu/host/presets/3/lobby/new=false}] run scoreboard players set #Store 4j.lobbytype 0
...
#Enabled maps
execute if score #Store 4j.gamestatus matches 0 run function 4jbattle:menu/load/host/preset/load/3/maps
