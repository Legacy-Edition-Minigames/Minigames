...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/bug/armorswapdrop=false}] run scoreboard players set #Store 4j.armorswapdrop 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/bug/foodcentral=false}] run scoreboard players set #Store 4j.foodcentfix 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/bug/leapfix=false}] run scoreboard players set #Store 4j.leapfix 0
#Large+ Cove Chests
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/bug/largepluscove=false}] run scoreboard players set #Store 4j.lpluscovefix 0
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/chest/refill=false}] run scoreboard players set #Store 4j.chestrefill 0
#Random Power Chests
execute if entity @s[advancements={4jbattle:menu/host/presets/5/chest/randompower=true}] run scoreboard players set #Store 4j.randompowerchest 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/chest/randompower=false}] run scoreboard players set #Store 4j.randompowerchest 0
#Random config
...
##Lobby settings
#Old lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/old=true}] run scoreboard players set #Store 4j.setlobbytype 0
#New lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/new=true}] run scoreboard players set #Store 4j.setlobbytype 1
#Anniversary lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/anniversary=true}] run scoreboard players set #Store 4j.setlobbytype 2
#Halloween lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/halloween=true}] run scoreboard players set #Store 4j.setlobbytype 3
#Festive lobby
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/festive=true}] run scoreboard players set #Store 4j.setlobbytype 4
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/spectator/allay=true}] run scoreboard players set #Store 4j.spectype 6
...
##Combat style
#Classic
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/classic=true}] run function 4jbattle:menu/load/host/combat/style/setclassic/scores
#Modern
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/modern=true}] run function 4jbattle:menu/load/host/combat/style/setmodern/scores
#Custom
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom=true}] run scoreboard players set #Store 4j.combatstyle 3

##Sword Blocking
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/swordblock=true}] run scoreboard players set #Store 4j.setswordblock 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/swordblock=false}] run scoreboard players set #Store 4j.setswordblock 0

##1.9 Weapon Damage
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/sword=true}] run scoreboard players set #Store 4j.setmoderndamage.sword 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/trident=true}] run scoreboard players set #Store 4j.setmoderndamage.trident 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/axe=true}] run scoreboard players set #Store 4j.setmoderndamage.axe 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/pickaxe=true}] run scoreboard players set #Store 4j.setmoderndamage.pickaxe 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/shovel=true}] run scoreboard players set #Store 4j.setmoderndamage.shovel 1
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/hoe=true}] run scoreboard players set #Store 4j.setmoderndamage.hoe 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/sword=false}] run scoreboard players set #Store 4j.setmoderndamage.sword 0
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/trident=false}] run scoreboard players set #Store 4j.setmoderndamage.trident 0
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/axe=false}] run scoreboard players set #Store 4j.setmoderndamage.axe 0
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/pickaxe=false}] run scoreboard players set #Store 4j.setmoderndamage.pickaxe 0
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/shovel=false}] run scoreboard players set #Store 4j.setmoderndamage.shovel 0
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage/hoe=false}] run scoreboard players set #Store 4j.setmoderndamage.hoe 0

##Attack Cooldown
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/cooldown=true}] run scoreboard players set #Store 4j.setattackcooldown 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/cooldown=false}] run scoreboard players set #Store 4j.setattackcooldown 0

##Critical Attacks
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/criticals=true}] run scoreboard players set #Store 4j.setcriticalhits 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/criticals=false}] run scoreboard players set #Store 4j.setcriticalhits 0

##Attack Speed
#Slow
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/attackspeed/slow=true}] run scoreboard players set #Store 4j.setattackspeed 0
#Normal
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/attackspeed/normal=true}] run scoreboard players set #Store 4j.setattackspeed 1
#Fast
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/attackspeed/fast=true}] run scoreboard players set #Store 4j.setattackspeed 2
#Fastest
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/attackspeed/fastest=true}] run scoreboard players set #Store 4j.setattackspeed 3
...
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/extendedpotionrange=true}] run scoreboard players set #Store 4j.extendedpotionrange 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/extendedpotionrange=false}] run scoreboard players set #Store 4j.extendedpotionrange 0

##Mods enable/disable toggle
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/mods/enabled=true}] run scoreboard players set #Store 4j.enablemods 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/mods/enabled=false}] run scoreboard players set #Store 4j.enablemods 0
