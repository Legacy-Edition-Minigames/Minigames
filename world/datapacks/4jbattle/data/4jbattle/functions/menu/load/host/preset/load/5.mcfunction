...
##Combat style
#Classic
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/classic=true}] run scoreboard players set #Store 4j.combatstyle 1
#Modern
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/modern=true}] run scoreboard players set #Store 4j.combatstyle 2
#Custom
