...
##1.9 Weapon Damage
#Enabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage=true}] run scoreboard players set #Store 4j.setmoderndamage 1
#Disabled
execute if entity @s[advancements={4jbattle:menu/host/presets/5/combat/style/custom/moderndamage=false}] run scoreboard players set #Store 4j.setmoderndamage 0
