...
#Fast Healing
execute if entity @s[advancements={4jbattle:menu/host/presets/5/hunger/fasthealing=true}] run scoreboard players set #Store 4j.hungertype 2
#Beta
execute if entity @s[advancements={4jbattle:menu/host/presets/5/hunger/beta=true}] run scoreboard players set #Store 4j.hungertype 3
...
execute if entity @s[advancements={4jbattle:menu/host/presets/5/lobby/new=false}] run scoreboard players set #Store 4j.lobbytype 0
...
##Display as loaded
tellraw @s {"text":"Loaded Preset 5!","color":"green"}
