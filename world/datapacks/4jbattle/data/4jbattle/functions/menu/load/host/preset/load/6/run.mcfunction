...
#Fast Healing
execute if entity @s[advancements={4jbattle:menu/host/presets/6/hunger/fasthealing=true}] run scoreboard players set #Store 4j.hungertype 2
#Beta
execute if entity @s[advancements={4jbattle:menu/host/presets/6/hunger/beta=true}] run scoreboard players set #Store 4j.hungertype 3
