...
execute if entity @s[advancements={4jbattle:menu/host/presets/1/version/1=false}] run function 4jbattle:menu/load/host/preset/update/1/1
...
execute if entity @s[advancements={4jbattle:menu/host/presets/1/version/4=false}] run function 4jbattle:menu/load/host/preset/update/4/1
