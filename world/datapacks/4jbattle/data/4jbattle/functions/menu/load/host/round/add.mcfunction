...
##Display Message
tellraw @a {"translate":"4j.menu.host.config.update.generic","with":[{"translate":"4j.menu.host.config.update.set","with":[{"translate":"4j.menu.host.config.update.rounds"},{"score":{"name":"#Store","objective":"4j.setround"}}]}]}
