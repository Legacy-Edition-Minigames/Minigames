...
execute if entity @s[advancements={4jmenu:config/optifine=false}] run loadresource city

##Load city-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jmenu:config/optifine=true}] run loadresource city-optifine
