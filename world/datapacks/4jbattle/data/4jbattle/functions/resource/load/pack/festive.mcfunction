...
execute if entity @s[advancements={4jbattle:config/optifine=false}] run loadresource festive

##Load festive-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jbattle:config/optifine=true}] run loadresource festive-optifine
