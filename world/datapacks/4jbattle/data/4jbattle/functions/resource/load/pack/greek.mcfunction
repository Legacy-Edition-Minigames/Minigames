...
execute if entity @s[advancements={4jbattle:config/optifine=false}] run loadresource greek

##Load greek-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jbattle:config/optifine=true}] run loadresource greek-optifine
