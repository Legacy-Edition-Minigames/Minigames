...
execute if entity @s[advancements={4jbattle:config/optifine=false}] run loadresource halloween

##Load halloween-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jbattle:config/optifine=true}] run loadresource halloween-optifine
