...
execute if entity @s[advancements={4jmenu:config/optifine=false}] run loadresource plastic

##Load plastic-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jmenu:config/optifine=true}] run loadresource plastic-optifine
