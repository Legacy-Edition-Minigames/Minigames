...
execute if entity @s[advancements={4jmenu:config/optifine=false,4jbattle:config/custompack=false}] run loadresource vanilla

##Load vanilla-optifine pack if user is using optifine and not using custompack
execute if entity @s[advancements={4jmenu:config/optifine=true,4jbattle:config/custompack=false}] run loadresource vanilla-optifine
