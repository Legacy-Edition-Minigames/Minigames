...
#Criminally_Silly
execute as @a[scores={heartcosmetic=31},tag=heart-criminally_silly] run function lem.base:clientconfig/heart/switch/custom/criminally_silly
execute as @a[scores={heartcosmetic=31},tag=!heart-criminally_silly] run function lem.base:clientconfig/heart/switch/notunlocked
#V3NCO
...
#SophiePancakes
execute as @a[scores={heartcosmetic=34},tag=heart-sophiepancakes] run function lem.base:clientconfig/heart/switch/custom/sophiepancakes
execute as @a[scores={heartcosmetic=34},tag=!heart-sophiepancakes] run function lem.base:clientconfig/heart/switch/notunlocked
#Nioum
