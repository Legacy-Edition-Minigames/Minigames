...
##Display message
tellraw @a[tag=moderator] ["",{"text":"[Mod] ","bold":true,"color":"aqua"},{"translate":"lem.config.mod.resethost.announce","with":[{"selector":"@s"}],"fallback":"Host options have been reset by %s","color":"blue"}]
