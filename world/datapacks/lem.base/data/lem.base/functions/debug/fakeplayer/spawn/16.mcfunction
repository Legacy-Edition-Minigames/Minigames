...
#P13
execute unless entity @a[scores={lem.pid=13}] run player 13 spawn
#P14
execute unless entity @a[scores={lem.pid=14}] run player 14 spawn
#P15
execute unless entity @a[scores={lem.pid=15}] run player 15 spawn
#P16
execute unless entity @a[scores={lem.pid=16}] run player 16 spawn
