...
execute if score #Store lem.glow matches 1 run effect give @a[tag=ingame,predicate=!lem.base:is_sneaking,gamemode=!spectator,nbt=!{ActiveEffects:[{Id:14}]}] glowing 1 0 true
