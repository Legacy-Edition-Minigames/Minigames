...
data merge block -342 63 -390 {Items:[{Count:1b,Slot:1b,id:"minecraft:bow",tag:{Damage:0}},{Count:1b,Slot:8b,id:"minecraft:bow",tag:{Damage:0}},{Count:10b,Slot:9b,id:"minecraft:arrow"},{Count:1b,Slot:13b,id:"minecraft:bow",tag:{Damage:0}},{Count:10b,Slot:14b,id:"minecraft:arrow"},{Count:10b,Slot:17b,id:"minecraft:arrow"},{Count:1b,Slot:20b,id:"minecraft:bow",tag:{Damage:0}},{Count:1b,Slot:24b,id:"minecraft:bow",tag:{Damage:0}}]}
data merge block -342 63 -389 {Items:[{Count:1b,Slot:0b,id:"minecraft:bow",tag:{Damage:0}},{Count:10b,Slot:2b,id:"minecraft:arrow"},{Count:10b,Slot:6b,id:"minecraft:arrow"},{Count:10b,Slot:9b,id:"minecraft:arrow"},{Count:1b,Slot:13b,id:"minecraft:bow",tag:{Damage:0}},{Count:1b,Slot:19b,id:"minecraft:bow",tag:{Damage:0}},{Count:10b,Slot:20b,id:"minecraft:arrow"},{Count:10b,Slot:23b,id:"minecraft:arrow"},{Count:1b,Slot:25b,id:"minecraft:bow",tag:{Damage:0}},{Count:10b,Slot:26b,id:"minecraft:arrow"}]}
data merge block -351 76 -404 {Items:[{Count:1b,Slot:0b,id:"minecraft:minecart"},{Count:1b,Slot:1b,id:"minecraft:minecart"},{Count:1b,Slot:2b,id:"minecraft:minecart"},{Count:1b,Slot:3b,id:"minecraft:minecart"},{Count:1b,Slot:4b,id:"minecraft:minecart"},{Count:1b,Slot:5b,id:"minecraft:minecart"},{Count:1b,Slot:6b,id:"minecraft:minecart"},{Count:1b,Slot:7b,id:"minecraft:minecart"},{Count:1b,Slot:8b,id:"minecraft:minecart"}],Lock:"1234"}
data merge block -357 76 -358 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_stal",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
data merge block -359 64 -357 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_blocks",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
...
data merge block -370 69 -366 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_mellohi",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
...
data merge block -376 63 -390 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_wait",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
data merge block -381 69 -393 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_11",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
data merge block -356 56 -380 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_cat",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
data merge block -376 63 -382 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_mall",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
...
data merge block -346 69 -359 {Items:[{Count:1b,Slot:13b,id:"minecraft:music_disc_chirp",tag:{CanPlaceOn:["minecraft:jukebox"],HideFlags:16}}]}
