...
execute as @s[scores={lem.gamecfg=61}] run function lem.base:menu/load/host/preset/save/run

##Open Preset load menu
execute as @s[scores={lem.gamecfg=62}] run function lem.base:menu/load/host/preset/load/run
