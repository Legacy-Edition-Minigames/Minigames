...
#RottenFlesh_
execute as fc1c5251-d348-4ce7-8782-e1711c1b16e8 run scoreboard players set @s lem.patreon 1
#MorbidlyABeast01
execute as e05ef0d0-aa6c-4c41-934c-44de6015849a run scoreboard players set @s lem.patreon 1
#KittyWulffie
