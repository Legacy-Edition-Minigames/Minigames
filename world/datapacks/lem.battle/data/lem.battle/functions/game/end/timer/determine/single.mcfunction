##Add damage dealt
execute as @a[tag=ingame,tag=player] run scoreboard players operation @s lem.battle.drawscore = @s lem.battle.damagedealt

##Remove damage taken
execute as @a[tag=ingame,tag=player] run scoreboard players operation @s lem.battle.drawscore -= @s lem.battle.damagetaken

##Add a bunch of score
scoreboard players add @a[tag=ingame] lem.battle.drawscore 9999999
...
execute as @a[tag=ingame,tag=player] if score @s lem.battle.drawscore = #highestScore lem.battle.drawscore run tag @s add Victor
...
scoreboard players remove @a[tag=ingame] lem.battle.drawscore 9999999
#Display
