...
##Display message
discordChatMSG {"translate":"lem.menu.host.config.update.generic","fallback":"The host has %s","with":[{"translate":"lem.battle.menu.host.config.update.item.random.disable","fallback":"removed %s Item Set from %s Item Set","with":[{"translate":"lem.battle.game.start.displaysettings.itemset.foodcentral","fallback":"Food Central"},{"translate":"lem.battle.game.start.displaysettings.itemset.random","fallback":"Random"}]}]}
