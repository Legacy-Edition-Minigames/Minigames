...
##Display message
discordChatMSG {"translate":"lem.menu.host.config.update.generic","fallback":"The host has %s","with":[{"translate":"lem.battle.menu.host.config.update.item.random.enable","fallback":"added %s Item Set to %s Item Set","with":[{"translate":"lem.battle.game.start.displaysettings.itemset.highpower","fallback":"High Power"},{"translate":"lem.battle.game.start.displaysettings.itemset.random","fallback":"Random"}]}]}
