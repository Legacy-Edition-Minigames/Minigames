...
##Armorbar
execute if score #Store lem.gamestatus matches 2 as @a[tag=ingame,tag=!notitle,tag=player,advancements={lem.battle:config/armorbar=false}] run function lem.battle:ui/display/game/armorbar/run
