...
##Armorbar
execute if score #Store lem.gamestatus matches 3..4 as @a[tag=ingame,tag=!notitle,tag=player,scores={serverutils.haslemclient=..1}] run userconfig @s test lem.battle:armorbar EQUAL true runFunction lem.battle:ui/display/game/armorbar/run
