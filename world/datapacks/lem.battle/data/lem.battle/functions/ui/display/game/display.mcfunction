...
#Spectating
execute if score #Store lem.plist matches ..8 as @a[tag=ingame,tag=!bedrock,gamemode=spectator] run function lem.base:ui/display/game/java/8
execute if score #Store lem.plist matches 9..10 as @a[tag=ingame,tag=!bedrock,gamemode=spectator] run function lem.base:ui/display/game/java/10
execute if score #Store lem.plist matches 11.. as @a[tag=ingame,tag=!bedrock,gamemode=spectator] run function lem.base:ui/display/game/java/16
